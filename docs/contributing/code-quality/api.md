...
| **L3** `cache-handler.ts` lines               | 888                | **675**                | −24%, public method names unchanged. Was 655 when this table was first written; slice 10 added 20 lines of dispatch hardening back                                                                           |
