...
export const envSchema = z.object({
  ...
  /** Max JSON request body size for Express (bytes). Default 10 MiB; raise for large CDM sync imports. */
  API_JSON_BODY_LIMIT_BYTES: optionalNumber(10 * 1024 * 1024),
  ...
  GOOGLE_CALLBACK_URL: optionalString('http://localhost:4000/api/auth/google/callback'),
  GOOGLE_PROJECT_CALLBACK_URL: optionalString('http://localhost:4000/api/auth/project/callback'),
  GOOGLE_AUTHORIZATION_URL: optionalString('https://accounts.google.com/o/oauth2/v2/auth'),
  GOOGLE_TOKEN_URL: optionalString('https://oauth2.googleapis.com/token'),
  GOOGLE_USERINFO_URL: optionalString('https://www.googleapis.com/oauth2/v3/userinfo'),
  ...
  JOBS_EVENT_RELAY_ENABLED: optionalBoolean(true),
  ...
  JOBS_WEBHOOK_DELIVERY_MAX_BATCHES: optionalNumber(20),
  JOBS_NOTIFICATION_DELIVERY_ENABLED: optionalBoolean(true),
  ...
  WEBHOOKS_DELIVERY_TIMEOUT_MS: optionalNumber(10_000),
  WEBHOOKS_ALLOW_HTTP: optionalBoolean(false),
  WEBHOOKS_SSRF_ALLOW_PRIVATE: optionalBoolean(false),
  WEBHOOKS_SSRF_ALLOWLIST: optionalString(''),
  WEBHOOKS_SSRF_DENYLIST: optionalString(''),
  WEBHOOKS_SIGNATURE_TIMESTAMP_TOLERANCE_SECONDS: optionalNumber(300),
  WEBHOOKS_SECRET_BYTES: optionalNumber(32),
  WEBHOOKS_RETRY_MAX_ATTEMPTS: optionalNumber(12),
  WEBHOOKS_RETRY_BASE_DELAY_SECONDS: optionalNumber(30),
  WEBHOOKS_RETRY_MAX_DELAY_SECONDS: optionalNumber(3600),
  WEBHOOKS_RETRY_HORIZON_HOURS: optionalNumber(24),
  NOTIFICATIONS_EMAIL_RETRY_MAX_ATTEMPTS: optionalNumber(6),
  NOTIFICATIONS_EMAIL_RETRY_BASE_DELAY_SECONDS: optionalNumber(60),
  NOTIFICATIONS_EMAIL_RETRY_MAX_DELAY_SECONDS: optionalNumber(3600),
  NOTIFICATIONS_EMAIL_RETRY_HORIZON_HOURS: optionalNumber(24),
