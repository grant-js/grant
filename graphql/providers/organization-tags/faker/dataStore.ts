...
// Type for OrganizationTag data without the resolved fields
export interface OrganizationTagData {
  id: string;
...
// Input type for creating organization-tag relationships
...
const generateInitialOrganizationTags = (): OrganizationTagData[] => {
...
const organizationTagConfig: EntityConfig<OrganizationTagData, CreateOrganizationTagInput, never> =
  {
    ...
    generateEntity: (input: CreateOrganizationTagInput, id: string): OrganizationTagData => {
...
export const getOrganizationTagsByOrganizationId = (
  organizationId: string
): OrganizationTagData[] => {
...
export const getOrganizationTagsByTagId = (tagId: string): OrganizationTagData[] => {
  return organizationTagsDataStore.getEntities().filter((ot) => ot.tagId === tagId);
};

export const addOrganizationTag = (organizationId: string, tagId: string): OrganizationTagData => {
...
export const deleteOrganizationTag = (id: string): OrganizationTagData | null => {
...
export const deleteOrganizationTagsByTagId = (tagId: string): OrganizationTagData[] => {
  const organizationTags = organizationTagsDataStore
    .getEntities()
