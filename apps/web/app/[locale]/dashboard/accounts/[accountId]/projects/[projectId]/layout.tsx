...
import { PersonalProjectNav } from '@/components/navigation/PersonalProjectNav';

interface PersonalProjectLayoutProps {
  children: React.ReactNode;
}

export default function PersonalProjectLayout({ children }: PersonalProjectLayoutProps) {
  return (
