...
interface RoleNavigationButtonProps {
  role: Role;
...
export function RoleNavigationButton({
  role,
  variant = 'outline',
  size = 'icon',
  className,
  round = true,
}: RoleNavigationButtonProps) {
  ...
  const href = useMemo(
    ...
    [params.organizationId, params.accountId, params.projectId, role.id]
  );
