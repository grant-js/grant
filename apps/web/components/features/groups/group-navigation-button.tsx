...
interface GroupNavigationButtonProps {
  group: Group;
...
export function GroupNavigationButton({
  group,
  variant = 'outline',
  size = 'icon',
  className,
  round = true,
}: GroupNavigationButtonProps) {
  ...
  const href = useMemo(
    ...
    [params.organizationId, params.accountId, params.projectId, group.id]
  );
