...
After implementation (each stack slice and before story→main), run an independent verification pass.

**Defined ≠ always active for the whole story** — invoke after a slice is ready to merge or when Senior QA / Principal requests a check. See `docs/contributing/agentic-sdlc.md`.
